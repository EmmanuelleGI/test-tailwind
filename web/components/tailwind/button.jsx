...
const styles = {
  base: [
    // Base
    'relative isolate inline-flex items-center justify-center gap-x-2 rounded-customBorderRadius text-base/6 font-custom',
    // Sizing
  ...
  solid: [
    ...
    'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(theme(borderRadius.customBorderRadius)-1px)] before:bg-[--btn-bg]',
    ...
    'after:absolute after:inset-0 after:-z-10 after:rounded-[calc(theme(borderRadius.customBorderRadius)-1px)]',
    // Inner highlight shadow
    'after:shadow-[shadow:inset_0_1px_theme(colors.white/15%)]',
    // White overlay on hover
    'after:data-[active]:bg-[--btn-hover-overlay] after:data-[hover]:bg-[--btn-hover-overlay]',
    // Dark mode: `after` layer expands to cover entire button
    'dark:after:-inset-px dark:after:rounded-customBorderRadius',
    // Disabled
  ...
  colors: {
    ...
    yellowCustom: [
      'text-yellow-950 [--btn-hover-overlay:theme(colors.white/25%)] [--btn-bg:theme(colors.yellow)]',
      '[--btn-icon:theme(colors.yellow.600)] data-[active]:[--btn-icon:theme(colors.yellow.700)] data-[hover]:[--btn-icon:theme(colors.yellow.700)]', 'shadow-shadowbutton'
    ],
    },
}
